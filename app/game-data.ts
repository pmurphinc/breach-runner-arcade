export type ShipId = "tank" | "wing" | "squid" | "rabbit" | "turtle" | "flash" | "hunter" | "flagship" | "kestrel" | "warden";
...
export const SHIPS: ShipSpec[] = [
  ...
  { id: "warden", name: "Warden", role: "Medium / Gunship", turn: 6, maxSpeed: 3, acceleration: 0.09, health: 200, gun: 1, thrust: 1, special: "Q: Overdrives the hull-mounted cannon for 5 seconds, doubling its fire rate and increasing engagement range.", unlock: "OPEN" },
];
...
export type ShipSpecial = {
  ...
  /** Duration of a held active effect. Instant specials omit this. */
...
export const SHIP_SPECIALS: Record<ShipId, ShipSpecial> = {
  ...
  kestrel: { name: "SALVAGE LINK", cooldownSeconds: 20, activeSeconds: 5, balancePoints: 14 },
  warden: { name: "SENTRY OVERDRIVE", cooldownSeconds: 22, activeSeconds: 5, balancePoints: 20 },
};

...
export type UpgradeDefinition = { id: string; name: string; description: string; category: UpgradeCategory; gameplayCategory: GameplayCategory; tier: 1; maxStacks: number; effect: UpgradeEffect; amount: number; weapons?: readonly RiftWeaponId[]; excludes?: readonly RiftWeaponId[] };
...
export const RIFT_UPGRADES: readonly UpgradeDefinition[] = [
  ...
  { id: "vector-nozzles", name: "VECTOR NOZZLES", description: "+8% turn and braking response", category: "ship", gameplayCategory: "mobility", tier: 1, maxStacks: 10, effect: "handling", amount: .08 },

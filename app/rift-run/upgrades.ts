...
export const RIFT_UPGRADES: readonly UpgradeDefinition[] = [
  ...
  { id: "weapons-mastery", name: "WEAPONS MASTERY", description: "+10% base cannon damage", category: "rift-tech", gameplayCategory: "offensive", tier: 1, maxStacks: Number.POSITIVE_INFINITY, repeatable: true, effect: "cannonDamage", amount: .1 },
  ...
  { id: "survival-mastery", name: "SURVIVAL MASTERY", description: "+10 maximum and current hull", category: "ship", gameplayCategory: "defensive", tier: 1, maxStacks: Number.POSITIVE_INFINITY, repeatable: true, effect: "hull", amount: 10 },
